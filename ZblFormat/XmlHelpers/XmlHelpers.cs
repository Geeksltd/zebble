...
using ZblFormat.Helpers;
using ZblFormat.Serialization;

namespace ZblFormat
{
    public static class XmlHelpers
    {
        public static string CleanupZebbleFile(string filePath, bool write)
        {
        ...
        static void WriteAttrbutes(XElement element, ZebbleWriter writer, IList<XAttribute> updatedAttributes)
        {
            var lineLength = GetElementLength(element) + GetAttributesLength(updatedAttributes);
        ...
        static void WriteElement(ZebbleWriter writer, XElement element, IList<XAttribute> updatedAttributes = null)
        {
            ...
            if (element.Name == "z-Component" && element.Parent == null)
            {
                ...
                WriteAttrbutes(element, writer, updatedAttributes);
            }
        ...
        static int GetElementLength(XElement element)
        {
            ...
            if (element.HasElements) length += 1;
            else length += 3;
