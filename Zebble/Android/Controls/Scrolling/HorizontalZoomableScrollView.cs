namespace Zebble.AndroidOS
{
    ...
    public class HorizontalZoomableScrollView : HorizontalScrollView, IScrollView, IZoomableScrollView, IPartialPagingScrollView, IPullToRefreshScrollView
    {
        ...
        public HorizontalZoomableScrollView(Zebble.ScrollView view) : base(Renderer.Context)
        {
            View = view;
            ...
            Post(() => new Java.Lang.Runnable(() => { ScrollTo(Scale.ToDevice(View.ScrollX), Scale.ToDevice(View.ScrollY)); })
            .Run());
        }

        [Preserve]
        public HorizontalZoomableScrollView(IntPtr ptr, JniHandleOwnership handle) : base(ptr, handle) { }
